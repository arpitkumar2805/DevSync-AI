package com.devsync.task.task.service;
...
import com.devsync.task.task.dto.*;
import com.devsync.task.task.entity.Task;
import com.devsync.task.task.entity.TaskDependency;
import com.devsync.task.task.repository.TaskDependencyRepository;
...
public class TaskService {
    ...
    // Project existence is not validated here: Project entities live in devsync-project-service's
    // own database. A real deployment should verify projectId via a call to that service.
    @Transactional
