package com.devsync.project.project.service;
...
import com.devsync.project.project.dto.*;
import com.devsync.project.project.entity.Project;
import com.devsync.project.project.entity.ProjectMember;
import com.devsync.project.project.repository.ProjectMemberRepository;
...
public class ProjectService {
    ...
    public PageResponse<ProjectMemberResponse> getMembers(UUID projectId, Pageable pageable) {
        ...
        return PageResponse.of(page.map(this::toMemberResponse));
    }
    ...
    // User profile fields (email, name) live in devsync-org-user-service's own database and
    // are intentionally left null here; a real deployment should enrich this via a Feign/REST
    // call to that service (or resolve it client-side) rather than joining across service DBs.
